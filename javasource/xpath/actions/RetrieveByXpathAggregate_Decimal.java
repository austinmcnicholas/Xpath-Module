...
public class RetrieveByXpathAggregate_Decimal extends CustomJavaAction<java.math.BigDecimal>
{
	...
	public java.math.BigDecimal executeAction() throws Exception
	{
		...
		BigDecimal result = xpathHelper.retrieveByXpathAggregateDecimal(getContext(), Xpath, AggregateType, attributeName, ReturnObjectType);
	...
	{
		return "RetrieveByXpathAggregate_Decimal";
	}
